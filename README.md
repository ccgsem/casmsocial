...
```bash
% uv run mpirun -n 1 python -m casmsocial.casmsocial config/casmsocial.yaml
```
...
% source ./.venv/bin/activate
(casmsocial)
(casmsocial) mpirun -n 1 python -m casmsocial.casmsocial config/casmsocial.yaml
....
...
root@d332db7567f5:/app# uv run mpirun -n 1 python -m casmsocial.casmsocial config/casmsocial_wc.yaml
```
