...
DEFAULT_MVP_ARTIFACT_PATHS: tuple[Path, ...] = (
    Path("output/mvp_summary.md"),
    Path("output/mvp_agent_log.parquet"),
    Path("output/mvp_behavior_log.parquet"),
    Path("output/mvp_manifest.json"),
    Path("output/mvp_2rank_summary.md"),
    Path("output/mvp_2rank_agent_log.parquet"),
    Path("output/mvp_2rank_behavior_log.parquet"),
    Path("output/mvp_routed_summary.md"),
    Path("output/mvp_routed_agent_log.parquet"),
    Path("output/mvp_routed_behavior_log.parquet"),
    Path("output/mvp_routed_plan_validation.json"),
    ...
    Path("output/mvp_built_roads_summary.md"),
    Path("output/mvp_built_roads_agent_log.parquet"),
    Path("output/mvp_built_roads_behavior_log.parquet"),
    Path("output/mvp_built_roads_plan_validation.json"),
    Path("output/mvp_delta_state_summary.md"),
    Path("output/mvp_delta_state_agent_log.parquet"),
    Path("output/mvp_delta_state_behavior_log.parquet"),
    ...
    Path("output/mvp_delta_state_validation.json"),
